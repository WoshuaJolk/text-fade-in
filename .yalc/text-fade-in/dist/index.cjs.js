...
var FadeIn = function FadeIn(_ref) {
  ...
  var fullText = React__namespace.Children.toArray(children).join(' ').replace(/\s+/g, ' ').trim();
  ...
  var splitText = function splitText() {
    if (lines) {
      ...
      var lineElements = React__namespace.Children.toArray(children);
      ...
      var text = React__namespace.Children.toArray(children).join('');
  ...
  return /*#__PURE__*/React__namespace.createElement("div", {
    ...
    "aria-label": fullText
  }, /*#__PURE__*/React__namespace.createElement("style", null, keyframesStyle), splitText());
};
